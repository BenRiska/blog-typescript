    ...
    content:[
        {
            ...
            element: "p",
            content: "I have recently picked up Typescript, and the first real project I undertook was migrating the codebase for my blog (this website) over from plain react javascript."
        },{
            element: "p",
            content: "I found adding the syntax a fairly seamless process, since modern react is written with hooks and functional components there isn't much needed to be done to make things type safe. I think if you’ve used a type declarative language like C# or python then It's pretty easy to get the hang of it."
        },{
            element: "p",
        ...
        {
            element: "p",
            content: "This worked fine, I was able to embed the pianoMusic variable in my JSX and the audio would render. However, when I tried the same method in Typescript I got this error:"
        },
        {
            element: "img",
        ...
        {
            element: "p",
            content: "The compiler generated by create-react-app doesn’t know how to find files with the .mp3 declaration, after some googling I found 2 ways to get around the issue:"
        },
        {
            element: "p",
            content: "1 - You can use the require method instead to bypass the compiler and import directly through javascript."
        },
        {
            element: "img",
        ...
        {
            element: "p",
            content: '2 - You can change the "react-app-env.d.ts" file to broaden the declaration scope so the compiler will recognise the file (I recommend this method). To do this just add the following code:'
        },
        {
            element: "img",
        ...
        {
            element: "p",
            content: 'Then click "Use Workspace Version"'
        },
        {
            element: "img",
        ...
        {
            element: "p",
            content: 'Those that do typically have a separate package specifically for Typescript that will be prefixed with the "@types" keyword, for example “npm install @types/react-router-dom“. However some packages, like GSAP will include Typescript support in the standard package.'
        },
        {
            element: "p",
            content: 'I recommend going through the documentation to check before installinga any package.'
        }
    ]
}]